...
This is an unofficial Buildkite plugin for [deploytarot.com](https://deploytarot.com). The readings, verdicts, share pages, API, and card artwork are provided by Deploy Tarot; this plugin only requests a reading and formats it for Buildkite logs.
